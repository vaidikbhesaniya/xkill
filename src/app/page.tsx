...
export default function Home() {
  return (
    <div className="h-screen flex justify-center items-center flex-col gap-[1rem] text-center p-[2rem]">
      ...
      <span className="text-[1.7rem] lg:text-[2.5rem] leading-[2rem] lg:leading-[2.5rem]">Level Up Your Tech Career in</span>
      ...
      <div className="bg-[#1B6EF3] px-[1rem] py-[0.8rem] rounded-lg cursor-pointer">
        <span className="text-[1.2rem] text-[#F2F2F2] leading-[1.2rem] py-[1rem]">Get Started</span>
      </div>
    </div>
  );
}
